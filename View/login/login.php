...
<nav id="minhanav" class="navbar navbar-inverse">
    ...
    <div class="container">
      ...
      <div class="col-sm-4" id="caixalogin">
        <div class="">
    <form method="POST" action="../../Controller/validacao/logar.php">
      <center><img src="../img/logo.fw.png" width="220px"></center>
    <div class="form-group">
      <label for="exampleInputEmail1">Usuário:</label>
      <input type="nome" name="usuario" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Digite seu nome de usuário" required="">
    ...
    <div class="form-group">
      ...
      <p>Não tem conta?<a class="link" href="../cad_cliente/cadastro.php"> Criar agora</a></p>
      <a class="link" href="../senha/recuperar.php">Esqueceu a senha?</a>
    </div>
    <div class="form-check">
      <input type="checkbox" class="form-check-input" id="exampleCheck1">
      <label class="form-check-label" for="exampleCheck1"> Mantenha-me conectado</label>
    </div>
    <button type="submit" class="btn btn-success" url="../index.html">Continuar</button>
