<?php
	...
	$nome = filter_input(INPUT_POST, 'nm_formulario', FILTER_SANITIZE_STRING);
    ...
    $get_data = "INSERT INTO formulario (nm_formulario, sobrenome, apelido, email, itens, data, hora) VALUES (:nome, :sobrenome, :apelido, :email, :itens, NOW(), NOW())";


    //$datahora = date('d-m-y H:i:s');
    $insert_data = $conexao->prepare($get_data);

    $insert_data->bindParam(':nm_formulario', $nome);
